# A simple script to test Euler functionalities.
import time
import json
import os
import torch
...
if __name__ == '__main__':
    ...
    args.resume = '/cluster/home/kiten/pretrained_model.pth'  # Path to the model checkpoint
    args.device = 'cuda:0'
    args.pre_norm = True
    args.pad_rec = True

    # Set the path to your folder
    folder_path = '/cluster/home/kiten/images/'
